...
import { Empty, MetricCard, PageHeader, Panel } from "@/components/ui";
...
export default async function FinanceReportsPage() {
  ...
  return <>
    ...
    <nav className="finance-subnav"><Link href="/finance">Thu phí & tái phí</Link><Link href="/finance/expenses">Chi phí</Link><Link className="finance-subnav-active" href="/finance/reports">Báo cáo thu chi</Link><Link href="/notifications">Thông báo</Link></nav>
