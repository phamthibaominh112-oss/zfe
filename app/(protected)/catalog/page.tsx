...
export default async function CatalogPage({ searchParams }: { searchParams: Promise<Record<string,string|undefined>> }) {
  ...
  return <>
    <PageHeader eyebrow="Danh mục học thuật" title="Chương trình, Level & Khung khóa học" description="Thiết lập chương trình, trình độ, tổng số giờ, số buổi và mục tiêu đầu ra trước khi mở lớp." actions={actions}/>
